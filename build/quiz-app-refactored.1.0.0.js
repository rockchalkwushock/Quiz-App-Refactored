...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var myQuiz = _controller2.default.getController();
	...
	function initLoad() {
	  ...
	  (0, _jquery2.default)('.answers-btn').on('click', function (event) {
	    event.preventDefault();
	
	    myQuiz.checkAnswer((0, _jquery2.default)(this).text());
	    myQuiz.getNextQuestion((0, _jquery2.default)('.question'));
	    (0, _jquery2.default)('.question-current').empty().append(_controller.MYLIBRARY.state.current_question);
	  });
	...
	function readyQuiz() {
	  populateItems();
	  myQuiz.getNextQuestion((0, _jquery2.default)('.question'));
	  myQuiz.renderAnswers((0, _jquery2.default)('.answers'));
	  (0, _jquery2.default)('.question-current').empty().append(_controller.MYLIBRARY.state.current_question);
	  (0, _jquery2.default)('.questions-total').empty().append('4');
	}
	
	/* ----------- c) restartQuiz ---------- */
	
	function restartQuiz() {
	  (0, _jquery2.default)('.restart-button').on('click', function (event) {
	    event.preventDefault();
	    myQuiz.reset((0, _jquery2.default)('.results-page'), (0, _jquery2.default)('.questions-page'));
	    initLoad();
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MYLIBRARY = exports.MYLIBRARY = MYLIBRARY || {};
	...
	*/
	...
	var ControllerFactory = function () {
	  ...
	  function ControllerFactory(state) {
	  ...
	  _createClass(ControllerFactory, [{
	    ...
	    value: function renderScore() {
	      (0, _jquery2.default)('.questions-page').hide();
	    ...
	    key: 'reset',
	    value: function reset(element, element2) {
	      this.state.items = [];
...
/***/ }
/******/ ]);
//# sourceMappingURL=quiz-app-refactored.1.0.0.js.map